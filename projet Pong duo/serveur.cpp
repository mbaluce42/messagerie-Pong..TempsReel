...
int main(int argc, char *argv[])
{
    ...
    while (start==true)
    {
        ...
        Vector2f posBatC1, posBatC2;

        status=client1.receive((char*)&posBatC1);
        if(status == OK){cout << "(SERVEUR)Position bat client 1 reçu" << endl;}
        else
        {
        ...
        status=client2.receive((char*)&posBatC2);
